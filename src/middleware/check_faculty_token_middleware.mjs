...
const checkFacultyTokenMiddleware = async (req, res, next) => {
  ...
  if (!isTokenInCorrectForm) {
    ...
    if (decoded) {
      tokenObject = await TokenUtil.getFacultyDataFromToken(token);
...
export default checkFacultyTokenMiddleware;
